...
import net.sourceforge.mochadoom.statusbar.IDoomStatusBar;
...
import static net.sourceforge.mochadoom.data.Defines.PLAYERRADIUS;
...
import static net.sourceforge.mochadoom.data.Tables.toBAMIndex;
import static net.sourceforge.mochadoom.doom.English.AMSTR_FOLLOWOFF;
import static net.sourceforge.mochadoom.doom.English.AMSTR_FOLLOWON;
import static net.sourceforge.mochadoom.doom.English.AMSTR_GRIDOFF;
import static net.sourceforge.mochadoom.doom.English.AMSTR_GRIDON;
import static net.sourceforge.mochadoom.doom.English.AMSTR_MARKEDSPOT;
import static net.sourceforge.mochadoom.doom.English.AMSTR_MARKSCLEARED;
...
import static net.sourceforge.mochadoom.rendering.line_t.ML_DONTDRAW;
