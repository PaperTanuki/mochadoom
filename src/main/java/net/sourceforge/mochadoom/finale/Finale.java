package net.sourceforge.mochadoom.finale;
...
import net.sourceforge.mochadoom.doom.gameaction_t;
...
import net.sourceforge.mochadoom.rendering.flat_t;
import net.sourceforge.mochadoom.rendering.patch_t;
import net.sourceforge.mochadoom.rendering.spritedef_t;
import net.sourceforge.mochadoom.rendering.spriteframe_t;
...
import static net.sourceforge.mochadoom.data.Defines.FF_FRAMEMASK;
...
import static net.sourceforge.mochadoom.doom.English.C1TEXT;
import static net.sourceforge.mochadoom.doom.English.C2TEXT;
import static net.sourceforge.mochadoom.doom.English.C3TEXT;
import static net.sourceforge.mochadoom.doom.English.C4TEXT;
import static net.sourceforge.mochadoom.doom.English.C5TEXT;
import static net.sourceforge.mochadoom.doom.English.C6TEXT;
import static net.sourceforge.mochadoom.doom.English.CC_ARACH;
import static net.sourceforge.mochadoom.doom.English.CC_ARCH;
import static net.sourceforge.mochadoom.doom.English.CC_BARON;
import static net.sourceforge.mochadoom.doom.English.CC_CACO;
import static net.sourceforge.mochadoom.doom.English.CC_CYBER;
import static net.sourceforge.mochadoom.doom.English.CC_DEMON;
import static net.sourceforge.mochadoom.doom.English.CC_HEAVY;
import static net.sourceforge.mochadoom.doom.English.CC_HELL;
import static net.sourceforge.mochadoom.doom.English.CC_HERO;
import static net.sourceforge.mochadoom.doom.English.CC_IMP;
import static net.sourceforge.mochadoom.doom.English.CC_LOST;
import static net.sourceforge.mochadoom.doom.English.CC_MANCU;
import static net.sourceforge.mochadoom.doom.English.CC_PAIN;
import static net.sourceforge.mochadoom.doom.English.CC_REVEN;
import static net.sourceforge.mochadoom.doom.English.CC_SHOTGUN;
import static net.sourceforge.mochadoom.doom.English.CC_SPIDER;
import static net.sourceforge.mochadoom.doom.English.CC_ZOMBIE;
import static net.sourceforge.mochadoom.doom.English.E1TEXT;
import static net.sourceforge.mochadoom.doom.English.E2TEXT;
import static net.sourceforge.mochadoom.doom.English.E3TEXT;
import static net.sourceforge.mochadoom.doom.English.E4TEXT;
import static net.sourceforge.mochadoom.doom.English.P1TEXT;
import static net.sourceforge.mochadoom.doom.English.P2TEXT;
import static net.sourceforge.mochadoom.doom.English.P3TEXT;
import static net.sourceforge.mochadoom.doom.English.P4TEXT;
import static net.sourceforge.mochadoom.doom.English.P5TEXT;
import static net.sourceforge.mochadoom.doom.English.P6TEXT;
import static net.sourceforge.mochadoom.doom.English.T1TEXT;
import static net.sourceforge.mochadoom.doom.English.T2TEXT;
import static net.sourceforge.mochadoom.doom.English.T3TEXT;
import static net.sourceforge.mochadoom.doom.English.T4TEXT;
import static net.sourceforge.mochadoom.doom.English.T5TEXT;
import static net.sourceforge.mochadoom.doom.English.T6TEXT;
