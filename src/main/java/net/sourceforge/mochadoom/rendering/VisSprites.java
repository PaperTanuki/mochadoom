...
import static net.sourceforge.mochadoom.data.Defines.FF_FULLBRIGHT;
import static net.sourceforge.mochadoom.data.Limits.MAXVISSPRITES;
...
import static net.sourceforge.mochadoom.rendering.Renderer.MINZ;
...
public final class VisSprites<V>
    ...
    public void AddSprites(sector_t sec) {
        ...
        else if (lightnum >= LIGHTSEGSHIFT)
            colormaps.spritelights = colormaps.scalelight[LIGHTSEGSHIFT - 1];
        else
