...
import net.sourceforge.mochadoom.gamelogic.UnifiedGameMap;
...
import net.sourceforge.mochadoom.rendering.drawfuns.DoomColumnFunction;
import net.sourceforge.mochadoom.rendering.drawfuns.DoomSpanFunction;
...
import static net.sourceforge.mochadoom.data.Defines.ANGLETOSKYSHIFT;
...
import static net.sourceforge.mochadoom.data.Defines.SIL_BOTH;
import static net.sourceforge.mochadoom.data.Defines.SIL_BOTTOM;
import static net.sourceforge.mochadoom.data.Defines.SIL_TOP;
import static net.sourceforge.mochadoom.data.Limits.MAXHEIGHT;
import static net.sourceforge.mochadoom.data.Limits.MAXSEGS;
import static net.sourceforge.mochadoom.data.Limits.MAXWIDTH;
...
import static net.sourceforge.mochadoom.data.Tables.DBITS;
import static net.sourceforge.mochadoom.data.Tables.FINEANGLES;
import static net.sourceforge.mochadoom.data.Tables.QUARTERMARK;
import static net.sourceforge.mochadoom.data.Tables.SlopeDiv;
import static net.sourceforge.mochadoom.data.Tables.addAngles;
...
import static net.sourceforge.mochadoom.data.Tables.finetangent;
...
import static net.sourceforge.mochadoom.rendering.LightsAndColors.LBITS;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.LIGHTBRIGHT;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.LIGHTLEVELS;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.LIGHTSCALESHIFT;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.LIGHTSEGSHIFT;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.LIGHTZSHIFT;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.MAXLIGHTSCALE;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.MAXLIGHTZ;
import static net.sourceforge.mochadoom.rendering.LightsAndColors.NUMCOLORMAPS;
import static net.sourceforge.mochadoom.rendering.line_t.ML_DONTPEGBOTTOM;
import static net.sourceforge.mochadoom.rendering.line_t.ML_DONTPEGTOP;
import static net.sourceforge.mochadoom.rendering.line_t.ML_MAPPED;
