...
import net.sourceforge.mochadoom.gamelogic.UnifiedGameMap.Enemies;
...
import static net.sourceforge.mochadoom.data.Limits.MAXSKULLS;
import static net.sourceforge.mochadoom.data.Limits.NUMBRAINTARGETS;
...
import static net.sourceforge.mochadoom.data.Tables.FINEMASK;
...
import static net.sourceforge.mochadoom.doom.player_t.LOWERSPEED;
import static net.sourceforge.mochadoom.doom.player_t.RAISESPEED;
import static net.sourceforge.mochadoom.doom.player_t.WEAPONBOTTOM;
import static net.sourceforge.mochadoom.doom.player_t.WEAPONTOP;
import static net.sourceforge.mochadoom.doom.player_t.ps_flash;
import static net.sourceforge.mochadoom.doom.player_t.ps_weapon;
...
import static net.sourceforge.mochadoom.gamelogic.mobj_t.MF_JUSTATTACKED;
