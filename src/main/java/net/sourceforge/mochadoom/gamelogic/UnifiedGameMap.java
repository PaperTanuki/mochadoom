...
import static net.sourceforge.mochadoom.data.Defines.RANGECHECK;
import static net.sourceforge.mochadoom.data.Defines.pw_allmap;
import static net.sourceforge.mochadoom.data.Defines.pw_infrared;
import static net.sourceforge.mochadoom.data.Defines.pw_invisibility;
...
import static net.sourceforge.mochadoom.data.Limits.BUTTONTIME;
import static net.sourceforge.mochadoom.data.Limits.MAXANIMS;
import static net.sourceforge.mochadoom.data.Limits.MAXBUTTONS;
import static net.sourceforge.mochadoom.data.Limits.MAXINT;
import static net.sourceforge.mochadoom.data.Limits.MAXINTERCEPTS;
import static net.sourceforge.mochadoom.data.Limits.MAXSPECIALCROSS;
import static net.sourceforge.mochadoom.data.Limits.MAXSWITCHES;
import static net.sourceforge.mochadoom.data.Limits.PLATSPEED;
import static net.sourceforge.mochadoom.data.Limits.PLATWAIT;
...
import static net.sourceforge.mochadoom.doom.English.GOTARMBONUS;
import static net.sourceforge.mochadoom.doom.English.GOTARMOR;
import static net.sourceforge.mochadoom.doom.English.GOTBACKPACK;
import static net.sourceforge.mochadoom.doom.English.GOTBERSERK;
import static net.sourceforge.mochadoom.doom.English.GOTBFG9000;
import static net.sourceforge.mochadoom.doom.English.GOTBLUECARD;
...
import static net.sourceforge.mochadoom.doom.English.GOTCLIPBOX;
import static net.sourceforge.mochadoom.doom.English.GOTHTHBONUS;
import static net.sourceforge.mochadoom.doom.English.GOTINVIS;
import static net.sourceforge.mochadoom.doom.English.GOTINVUL;
import static net.sourceforge.mochadoom.doom.English.GOTLAUNCHER;
import static net.sourceforge.mochadoom.doom.English.GOTMAP;
import static net.sourceforge.mochadoom.doom.English.GOTMEDIKIT;
import static net.sourceforge.mochadoom.doom.English.GOTMEDINEED;
import static net.sourceforge.mochadoom.doom.English.GOTMEGA;
import static net.sourceforge.mochadoom.doom.English.GOTMSPHERE;
import static net.sourceforge.mochadoom.doom.English.GOTPLASMA;
import static net.sourceforge.mochadoom.doom.English.GOTREDCARD;
import static net.sourceforge.mochadoom.doom.English.GOTREDSKULL;
import static net.sourceforge.mochadoom.doom.English.GOTROCKBOX;
import static net.sourceforge.mochadoom.doom.English.GOTROCKET;
import static net.sourceforge.mochadoom.doom.English.GOTSHELLBOX;
import static net.sourceforge.mochadoom.doom.English.GOTSHELLS;
import static net.sourceforge.mochadoom.doom.English.GOTSHOTGUN;
import static net.sourceforge.mochadoom.doom.English.GOTSHOTGUN2;
import static net.sourceforge.mochadoom.doom.English.GOTSTIM;
import static net.sourceforge.mochadoom.doom.English.GOTSUIT;
import static net.sourceforge.mochadoom.doom.English.GOTSUPER;
import static net.sourceforge.mochadoom.doom.English.GOTVISOR;
    ...
    class Plats {
       ...
       void AddActivePlat(plat_t plat) {
        ...
        public void initActivePlats() {
            ...
            activeplats = new plat_t[net.sourceforge.mochadoom.data.Limits.MAXPLATS];
        }
