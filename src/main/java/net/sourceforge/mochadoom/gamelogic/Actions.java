...
import net.sourceforge.mochadoom.data.*;
...
import net.sourceforge.mochadoom.doom.*;
...
import static net.sourceforge.mochadoom.data.Defines.*;
...
import static net.sourceforge.mochadoom.doom.English.*;
import static net.sourceforge.mochadoom.gamelogic.ChaseDirections.*;
import static net.sourceforge.mochadoom.gamelogic.DoorDefines.*;
import static net.sourceforge.mochadoom.gamelogic.MapUtils.AproxDistance;
import static net.sourceforge.mochadoom.gamelogic.mobj_t.*;
import static net.sourceforge.mochadoom.menu.BBox.*;
import static net.sourceforge.mochadoom.menu.fixed_t.*;
import static net.sourceforge.mochadoom.rendering.line_t.*;
...
/*         if ( p==null )
  ...
  protected void VerticalDoor(line_t line, mobj_t thing) {
    ...
    switch (line.special) {
      ...
      case 32:
        ...
        if (!player.cards[Card.it_bluecard.ordinal()] && !player.cards[Card.it_blueskull
            .ordinal()]) {
      ...
      case 34:
        ...
        if (!player.cards[Card.it_yellowcard.ordinal()] && !player.cards[Card.it_yellowskull
            .ordinal()]) {
  ...
  mobj_t SpawnMapThing(mapthing_t mthing) {
    ...
    if (i == NUMMOBJTYPES) {
      System.err
          .printf("P_SpawnMapThing: Unknown type %d at (%d, %d)", mthing.type, mthing.x, mthing.y);
      return null;
    }
    ...
    if (DM.nomonsters && (i == mobjtype_t.MT_SKULL.ordinal() || eval(
