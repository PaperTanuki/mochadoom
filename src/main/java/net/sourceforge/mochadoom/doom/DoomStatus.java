...
import net.sourceforge.mochadoom.menu.IUseVariables;
...
import static net.sourceforge.mochadoom.data.Limits.MAXWADFILES;
import static net.sourceforge.mochadoom.data.Limits.MAX_DM_STARTS;
